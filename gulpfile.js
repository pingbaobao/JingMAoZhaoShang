...
const config = {
  ...
  vendor: [
    ...
    'app/vendor/swiper/swiper.min.js',
    'app/vendor/city-picker.js'
  ],
  vendor_css:[
    'app/vendor/swiper/swiper.min.css',
    'app/vendor/layer/layer.css'
  ],
  //压缩配置
  uglify: {
    compress: {
...
//整体打包
gulp.task('build-start', ['vendorJs','html', 'scripts', 'styles', 'fonts', 'extras'], () => {
